...
}var ascendingBisect = bisector(ascending);var slice = Array.prototype.slice;function identity(x) {
  return x;
}var top = 1,
    right = 2,
    bottom = 3,
...
var durationWeek = 6048e5;var day = newInterval(function(date) {
...
var bisectRight = ascendingBisect$1.right;var e10 = Math.sqrt(50),
    e5 = Math.sqrt(10),
    e2 = Math.sqrt(2);
